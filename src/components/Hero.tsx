...
export default function Hero() {
  ...
  const fade = (delay: number, className: string, children: ReactNode) => (
    <div
  ...
  return (
    <section id="top" className="relative flex min-h-[100svh] items-end overflow-hidden bg-ink">
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-5 pb-14 pt-36 sm:px-8">
        {fade(150, 'mb-7 flex items-center gap-4', (
          <>
        ...
        {fade(600, 'mt-7 max-w-md', (
          <p className="text-[15px] font-light leading-relaxed text-ivory/70">
            Considered objects for the companions we love — leather, stoneware and wool,
            designed with care and made to be lived with.
          </p>
        ))}

        {fade(750, 'mt-9 flex flex-wrap items-center gap-4', (
          <>
            <button
              type="button"
              onClick={() => go('dogs')}
        ...
        {/* bottom meta strip */}
        {fade(950, 'mt-16 flex items-end justify-between', (
          <>
